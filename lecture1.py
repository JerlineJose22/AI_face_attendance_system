...
class Face_Recognizer:
    ...
    def draw_note(self, img_rd):
        ...
        cv2.putText(img_rd, "Making attendance for lecture 1", (20, 40), self.font, 1, (255, 255, 255), 1, cv2.LINE_AA)
    ...
    def run(self):
        ...
        def cam(x):
            ...
            # for number in range( 11):  # Insert numbers from -100 to 100 (infinite list)
